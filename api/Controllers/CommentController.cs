...
namespace api.Controllers
{
    ...
    public class CommentController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create([FromRoute] string symbol, [FromRoute] int stockId, CreateCommentDto commentData)
        {
            ...
            var commentModel = commentData.ToCommentFromCreateDto(stock.Id);
